...
<script>
    export default {
            ...
            return {
                ...
                rules: {
                    name: [
                        ...
                        {min: 1, max: 30, message: '名称不能少于一个字', trigger: 'blur'}
                    ],
                    author: [
        ...
        methods: {
            submitForm(formName) {
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        axios.post("http://localhost:8181/book/update", this.ruleForm)
        ...
        created() {
            const _this = this;
            axios.get("http://localhost:8181/book/find/" + this.$route.query.id)
                .then(function (response) {
